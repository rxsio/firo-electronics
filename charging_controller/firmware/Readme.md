...
| CMD Retract probe         | 0x03       | Requests the controller to retract the charging probes.                                                                                                   |
...
| RESP Temperature          | 0x8B       | Sent after receiving an RTR message with this device's CAN ID. The second byte encodes the temperature in full degrees (int8_t).                          |
